...
I'll draft:
- `proposal.md` (what & why) — confirmed by the human in step ②
- `design.md`   (how) — deepened by Superpowers `brainstorming` in step ③
- `tasks.md`    (implementation steps) — atomized by Superpowers `writing-plans` in step ③
